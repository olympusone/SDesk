...
ActiveRecord::Schema.define(version: 2018_10_06_113608) do
  ...
  create_table "file_attachments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["resource_type", "resource_id"], name: "index_file_attachments_on_resource_type_and_resource_id"
  end
  ...
  create_table "ticket_templates", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.bigint "department_id"
    t.bigint "agent_id"
    t.index ["agent_id"], name: "index_ticket_templates_on_agent_id"
    t.index ["department_id"], name: "index_ticket_templates_on_department_id"
  end
